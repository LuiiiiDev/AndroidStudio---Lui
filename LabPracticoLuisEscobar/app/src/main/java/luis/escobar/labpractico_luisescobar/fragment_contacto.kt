...
class fragment_contacto : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btnMostrar = root.findViewById<Button>(R.id.btnMostrar2)

        btnMostrar.setOnClickListener {
            Toast.makeText(context, "20230639@ricaldone.edu.sv", Toast.LENGTH_SHORT).show()
